...
## 游戏内文本使用的字体。
define gui.text_font = "SarasaGothicSC-Light.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "SarasaGothicSC-Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "SarasaUiSC-Regular.ttf"
